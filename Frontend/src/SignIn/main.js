addEventListener("DOMContentLoaded", function() {
    ...
    myShowPasswordButton.addEventListener("click", (event) => {
        ...
        if (activeImage) {
            myPasswordImage.src = "/Frontend/src/SvgAndImg/eye_svgrepo.com.png";
            myPasswordInput.type = "";

        }else {
            myPasswordImage.src = "/Frontend/src/SvgAndImg/eye-closed_svgrepo.com.png";
    ...
    myShowPasswordButton2.addEventListener("click", (event) => {
        ...
        if (activeImage2) {
            myPasswordImage2.src = "/Frontend/src/SvgAndImg/eye_svgrepo.com.png";
            myNewPasswordInput.type = "";

        }else {
            myPasswordImage2.src = "/Frontend/src/SvgAndImg/eye-closed_svgrepo.com.png";
    ...
    myShowPasswordButton3.addEventListener("click", (event) => {
        ...
        if (activeImage3) {
            myPasswordImage3.src = "/Frontend/src/SvgAndImg/eye_svgrepo.com.png";
            myCheckedPasswordInput.type = "";

        }else {
            myPasswordImage3.src = "/Frontend/src/SvgAndImg/eye-closed_svgrepo.com.png";
...
mySignInbutton.addEventListener("click", (event) => {
    ...
    myLowerRightPara.addEventListener("click", (event) => {
        ...
        window.location.replace("/Frontend/src/SignUp/main.html");
    })
